...
plugins=(git wd zsh-autosuggestions zsh-syntax-highlighting fzf)
...
# location of Unity script templates
function uscript() {
    echo "cd /Applications/Unity/Hub/Editor/"
    echo -e "\033[1;31mthen go to specific version you are interested in\033[0m"
